...
def calcula_equilibrio_financeiro(request):
    ...
    total_de_gastos_no_mes = total_gastos_essenciais + total_gastos_nao_essenciais

    try: 
        percentual_gastos_essenciais = (total_gastos_essenciais * 100)/total_de_gastos_no_mes
        percentual_gastos_nao_essenciais = (total_gastos_nao_essenciais * 100)/total_de_gastos_no_mes
