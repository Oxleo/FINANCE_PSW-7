...
def home(request):
    ...
    percentual_gastos_essenciais, percentual_gastos_nao_essenciais = calcula_equilibrio_financeiro(0)
...
def cadastrar_categoria(request):
    ...
    categoria.save()
    messages.add_message(request, constants.SUCCESS, 'Categoria cadrastada com sucesso')
